...
export function MapElevation({ title, showDetailsLabel }) {
  return (
    <section className="py-12 md:py-16 px-4" aria-labelledby="map-elevation-heading">
      ...
      <div className="mx-auto max-w-6xl rounded-radius-card overflow-hidden bg-neutral-100 border border-neutral-200 min-h-[320px] flex flex-col items-center justify-center gap-4 p-6">
