...
export function TourCard({
  ...
  return (
    <Card className="group rounded-card-lg shadow-card hover:shadow-xl focus-within:shadow-xl transition-all duration-300 hover:-translate-y-1 focus-within:-translate-y-1 overflow-hidden">
