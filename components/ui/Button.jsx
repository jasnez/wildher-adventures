...
export function Button({
  ...
  const base =
    'inline-flex items-center justify-center font-semibold rounded-button transition-colors duration-200 disabled:opacity-50 disabled:pointer-events-none min-w-[44px] motion-safe:active:scale-[0.98]';
