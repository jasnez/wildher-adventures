            ...
            {guides.map((guide) => (
              <li key={guide._id}>
                <Link
                  ...
                  className="block group rounded-card-lg overflow-hidden shadow-card hover:shadow-xl focus-visible:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary-green transition-all"
                >
