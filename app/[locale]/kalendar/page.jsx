                    ...
                    return (
                      <li key={`${entry.tour._id}-${i}`}>
                        <Link
                          ...
                          className="flex flex-col sm:flex-row sm:items-center gap-4 rounded-card border border-neutral-200 bg-white p-4 hover:border-brand-primary-green transition-colors"
                        >
                          {entry.tour.cover && (
