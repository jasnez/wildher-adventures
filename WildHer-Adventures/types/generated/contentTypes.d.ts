...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u010Clanci / journal \u2014 pri\u010De s tura, savjeti, destinacije';
...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Destinacije i lokacije \u2014 planine, regije, mjesta za ture';
  ...
  attributes: {
    country: Schema.Attribute.String & Schema.Attribute.DefaultTo<'BiH'>;
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ture i iskustva \u2014 jednodnevne, vikend, ekspedicije, retreat';
    displayName: 'Tour';
    pluralName: 'tours';
    singularName: 'tour';
  };
  ...
  attributes: {
    availableDates: Schema.Attribute.JSON;
    category: Schema.Attribute.Enumeration<
      ['one-day', 'weekend', 'expedition', 'retreat']
    >;
    cover: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    difficulty: Schema.Attribute.Enumeration<
      ['easy', 'moderate', 'challenging', 'demanding', 'expert']
    >;
    duration: Schema.Attribute.String;
    elevationM: Schema.Attribute.Integer;
    excluded: Schema.Attribute.RichText;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    images: Schema.Attribute.Media<'images', true>;
    included: Schema.Attribute.RichText;
    itinerary: Schema.Attribute.RichText;
    lengthKm: Schema.Attribute.Float;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    physicalPreparation: Schema.Attribute.RichText;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatToBring: Schema.Attribute.RichText;
  };
}
